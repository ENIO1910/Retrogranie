...
<div class="full">
	<div class ="header">
		<div class = "logo">
		<img src="img/pad.png" alt="png"/> <span style="color:#c34f4f">Retro</span><span>granie.com</span>
		</div>
	</div>
	<div class="nav">
	<ol>
	...
	<div class="galeria">
		<a style="text-decoration: none" href ="quiz.php">
			<img class="miniatura" src="img/contra.jpg" alt = "Contra" >
		</a>

		<a style="text-decoration: none" href ="quiz-mario.php">
			<img class="miniatura" src="img/mario.png" alt = "Mario" >
		</a>
			<br>
		<a style="text-decoration: none" href ="quiz-ducktales.php">
			<img class="miniatura" src="img/ducktales.jpg" alt = "Mario" >
		</a>

		<a style="text-decoration: none" href ="quiz-zelda.php">
			<img class="miniatura" src="img/zelda.jpg" alt = "Mario" >
		</a>
