...
<div class="full">
	...
	<div class="galeria">
		<a style="text-decoration: none" href ="quiz-tennis.php">
			<img class="miniatura" src="img/tennis.jpg" alt = "Tennis" >
		</a>

		<a style="text-decoration: none" href ="quiz-Goal3.php">
			<img class="miniatura" src="img/goal3.jpg" alt = "Goal 3" >
		</a>
			<br>
		<a style="text-decoration: none" href ="quiz-Excitebike.php">
			<img class="miniatura" src="img/Excitebike.jpg" alt = "Excitebike" >
		</a>

		<a style="text-decoration: none" href ="quiz-IkeIke.php">
			<img class="miniatura" src="img/IkeIke.jpg" alt = "Ike Ike Hockey" >
		</a>
