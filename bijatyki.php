...
<div class="full">
	...
	<div class="galeria">
		<a style="text-decoration: none" href ="quiz-MortalKombat.php">
			<img class="miniatura" src="img/MortalKombat.jpg" alt = "Mortal Kombat" >
		</a>

		<a style="text-decoration: none" href ="quiz-Nekketsu.php">
			<img class="miniatura" src="img/Nekketsu.jpg" alt = "Nekketsu K.D" >
		</a>
			<br>
		<a style="text-decoration: none" href ="quiz-Double_Dragon.php">
			<img class="miniatura" src="img/Double_Dragon.jpg" alt = "DoubleDragon" >
		</a>

		<a style="text-decoration: none" href ="quiz-Turtle.php">
			<img class="miniatura" src="img/Turtle_T.jpg" alt = "Turtle T." >
		</a>
